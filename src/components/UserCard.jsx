            ...
            const users = props.Users.map(user => (
                <Card key={user.id}  className="user--cards">
                    ...
                    <CardContent className='user--cards__info'>
                        ...
                        <Typography variant="body1" gutterBottom>
                            <span className="bold">Company:</span> {user.company.name}
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                            <span className="bold">Website:</span> {user.website}
                        </Typography>
                        <Typography variant="body1" gutterBottom>
                            <span className="bold">Address:</span> {user.address.street}, {user.address.suite}, {user.address.city}, {user.address.zipcode}
                        </Typography>
                    </CardContent>
                </Card>
            ));
